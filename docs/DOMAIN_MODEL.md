...
Legal reachability does not guarantee habitat suitability or survival. The simulation resolves the consequences after relocation.
...
- An initial MVP world has exactly five species: two producers, two herbivores, and one predator.
